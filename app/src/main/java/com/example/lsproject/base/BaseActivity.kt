...
open class BaseActivity : BaseActivity2() {
    ...
    protected fun setTextTitle(title: String) {
        if ((findViewById<TextView>(R.id.tv_toolsbar_title)) != null) {
     ...
     */
    protected fun setLeftButton(isShow: Boolean, resId: Int, onClickListener: View.OnClickListener) {
        val iv_left = findViewById<ImageView>(R.id.iv_left) as ImageView
        if (iv_left != null) {
            if (isShow) {
