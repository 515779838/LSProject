...
public class BdzyFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_bdzy, container, false);
        initView();
        return mView;
    }
...
//        pullToRefreshListView.setAdapter(adapter);
        ...
        if (adapter == null){
            adapter = new BdzyAdapter(pxjhBeanList,getActivity(),"");
            pullToRefreshListView.setAdapter(adapter);
        }else{
