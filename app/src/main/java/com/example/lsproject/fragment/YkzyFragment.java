...
import com.example.lsproject.adapter.YkzyAdapter;
 ...
 * 优课资源
 */
public class YkzyFragment extends BaseFragment {

    private PullToRefreshListView pullToRefreshListView;
    private YkzyAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_ykzy, container, false);
        initView();
        return mView;
    }
...
//        pullToRefreshListView.setAdapter(adapter);
        ...
        if (adapter == null){
            adapter = new YkzyAdapter(pxjhBeanList,getActivity(),"");
            pullToRefreshListView.setAdapter(adapter);
        }else{
