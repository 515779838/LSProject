 ...
 * 通识资源
 */
public class TszyFragment extends BaseFragment {


    private PullToRefreshListView pullToRefreshListView;
    private TbzyAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_tszy, container, false);
        initView();
        return mView;
    }
...
//        pullToRefreshListView.setAdapter(adapter);
        ...
        if (adapter == null){
            adapter = new TbzyAdapter(pxjhBeanList,getActivity(),"1");
            pullToRefreshListView.setAdapter(adapter);
        }else{
        ...
        pullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getActivity(), TszyDetailActivity.class);
